...
LIBS= -lglfw3 -lGLEW
OUTPUT= bin/app
DEPENDENCIES= src/renderingHead/shader.cpp src/renderingHead/texture.cpp  src/renderingHead/objloader.cpp  src/renderingHead/vboindexing.cpp src/renderingHead/matrices.cpp src/renderingHead/vectors.cpp  src/renderingHead/model.cpp src/renderingHead/line.cpp
